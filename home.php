    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          ...
          <h2>Easily Manage your Visitors</h2>
        </div>
      </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row content">
          <div class="col-lg-10" style="margin-left:100px;">
            <p>Visitor Management System is a system for all kind of capartments or business organizations. 
              visitors can check-in and print their badges. The Admin can log visitor’s
               check-in and check-out, employee’s check-in and check-out and many more. </p>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Abayo Akinyi</span></strong>. All Rights Reserved
        </div>
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">Abayo Akinyi</a>
        </div>
      </div>
